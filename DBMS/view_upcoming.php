...
<body>
	...
	<center>
		<div class="wrapper">
		<div class="container">
		<h2>My Upcoming Jobs</h2><br><br>
<?php

require_once 'dbconnect.php';
session_start();
$org_reg = $_SESSION["email_id"];
$query = "SELECT * FROM service_tasks ,service_listing,consumer WHERE service_tasks.user_id = service_listing.user_id AND
  service_tasks.service_name = service_listing.service_name AND service_tasks.list_date = service_listing.list_date AND
   service_tasks.provider_id = '$org_reg' AND service_listing.alloted = 1 AND service_tasks.servicing_date > NOW() AND 
   consumer.user_id = service_listing.user_id ";
$result = mysqli_query($con, $query);
$numResults = mysqli_num_rows($result);

if($numResults == 0){
	echo "<br><br><br><center><h1>No Upcoming Services Found<br></h1> </center>";

}
else{ 
    echo "<center><table> <tr><th>Service Name</th> <th>Servicing Date</th> <th>Duration</th><th>Address</th><th>Service Charge</th> <th>Customer</th></tr>";
