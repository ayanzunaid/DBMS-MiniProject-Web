...
$query = "SELECT * FROM serviceman WHERE provider_id='$email' AND password='$old_password'";
...
{
	$query = "UPDATE serviceman SET password = '$new_password' WHERE provider_id='$email' AND password='$old_password' ";
